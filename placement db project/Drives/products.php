...
<html>
	<head>
		...
		<title>RNSIT-PMS | Campus Drives</title>
		<meta name="viewport"
					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/home.php">RNSIT-PMS<i>Goto Placement Homepage</i></a>
							</li>
							<li class="hvr-sweep-to-bottom active">
								<a href="index.php">Home<i>Get the Overview of the Site</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="about.php">Gallery<i>Go to Gallery</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>RNSIT, channasandra
							<span>Uttarhalli, Bengaluru.</span>
                            Pincode-560098
						</p>
					</div>
					<div class="phone">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">RNS Institute of Technology</h6>
					<h4>
						<a href="../../Drives/index.php" style="color: white">Placement Management System</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
