        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.rnsit.ac.in">RNS Institute of Technology</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>ADDRESS</h3>
					<p>RNSIT, Channasandra</p>
					<p>RR Nagar, Bengaluru - 560098</p>
					<p>+91 9620759395</p>
					<a href="mailto:smartankit70@gmail.com">smartankit70@gmail.com</a>
				</div>
