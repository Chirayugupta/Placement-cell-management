...
$hisofbk = $_POST['hob'];
$dety = $_POST['dy'];
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='$branch' and SSLC>='$sslc' and `PU`>='$puaggregate' and BE>='$beaggregate' and Backlogs='$backlogs' and HofBacklogs='$hisofbk' and DetainYears='$dety'" ; 
 //run the query
