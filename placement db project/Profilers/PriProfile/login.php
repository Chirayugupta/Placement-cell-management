          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                   <li>
                  <a href="../../Homepage/home.php">Home RNSIT-PMS</a>
                </li>
                <li>
...
$RESULT=mysql_query("SELECT DISTINCT count(CompanyName) from addpdrive where PVenue LIKE '%RNSIT%'");
$data=mysql_fetch_assoc($RESULT);
echo "<br><br><h3>Companies In Our Campus In This Year&nbsp:&nbsp";
echo $data['count(CompanyName)'];
$RESULT=mysql_query("SELECT count(Attendence) from updatedrive where Attendence=1");
$data=mysql_fetch_assoc($RESULT);
echo "<br><BR>Number of Students Attended In This Year&nbsp:&nbsp";
echo $data['count(Attendence)'];
$RESULT=mysql_query("SELECT count(Placed) from updatedrive where Placed=1");
$data=mysql_fetch_assoc($RESULT);
